...
export class IgHttpService extends Http {
  ...
  post(url: string, body: any, options?: RequestOptionsArgs): Observable<Response> {
    ...
    return super.post(url, body, options).do(() => this.loadMask.hideMask());
  }

  put(url: string, body: any, options?: RequestOptionsArgs): Observable<Response> {
    this.loadMask.showMask();
    return super.put(url, body, options).do(() => this.loadMask.hideMask());
  }

  delete(url: string, options?: RequestOptionsArgs): Observable<Response> {
    this.loadMask.showMask();
    return super.delete(url, options).do(() => this.loadMask.hideMask());
  }
}
